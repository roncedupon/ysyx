...
#define ARRLEN(arr) (int)(sizeof(arr) / sizeof(arr[0]))//总大小除一个元素的大小就是长度,也就是返回
...
#define MUX_MACRO_PROPERTY(p, macro, a, b) MUX_WITH_COMMA(concat(p, macro), a, b)//pmacro a,b
//macro:宏
...
0000_0000_0001_0000---左移(8-5+1=4)位
0000_0000_0000_0001---再减1
0000_0000_0000_1111---mask结果⭐

0000_0000_0000_0111--⭐结果--也就是截取了第8~5位(0111)的值
